  ...
  <div id="investor-relations">
    <div class="w-full hero pt-8">
      <div class="w-full mt-8 mb-32 flex items-center bg-grey py-16 px-8">
        <div class="max-w-6xl flex flex-col lg:flex-row items-center mx-auto">
          <div class="flex flex-col pr-12">
            <h3>INVESTORS</h3>
            <h1>Investor Relations</h1>
          </div>
          <div class="flex flex-col lg:pl-12 lg:border-l border-grey">
            <p class="mb-8">
            ...
            <div class="flex flex-col lg:flex-row">
              <a href="#" class="w-full button mr-4">2019 Annual Report</a>
              <a href="#" class="w-full button">Investor Presentation</a>
            </div>
          </div>
        </div>
      </div>
    </div>
    <div class="flex flex-col lg:flex-row w-full p-12 pt-24 md:pt-12 max-w-6xl mx-auto">
      <div style="flex:75%;">
      ...
      <div style="flex:25%;" class="mt-8 lg:mt-0">
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="flex flex-col md:flex-row w-full py-12">
        <div
